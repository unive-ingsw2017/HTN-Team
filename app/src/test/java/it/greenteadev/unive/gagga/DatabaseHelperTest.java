...
import it.greenteadev.unive.gagga.data.local.Db;
import it.greenteadev.unive.gagga.data.local.DbOpenHelper;
import it.greenteadev.unive.gagga.test.common.TestDataFactory;
import it.greenteadev.unive.gagga.util.DefaultConfig;
...
public class DatabaseHelperTest {
    ...
    public void setRibots() {
       /* Ribot ribot1 = TestDataFactory.makeRibot("r1");
        ...
        mDatabaseHelper.setStations(ribots).subscribe(result);
    ...
    public void getRibots() {
        ...
        mDatabaseHelper.setStations(ribots).subscribe();
